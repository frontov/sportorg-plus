...
* Добавлена поддержка многодневных соревнований (> 24 часов). Формат отображения времени "чч:мм:сс+д".
* Добавлена поддержка системы отметки HuiChang.
* Добавлена станция отсечки в настройках хронометража (по умолчанию 250).
* Обновлен диалог настроек хронометража.
* Выбор системы отметки в диалоге настроек хронометража.
* Обратная нумерация строк на вкладке результатов.
* Использование минимального/максимального возраста участника группы для фильтрации доступных групп в диалоге редактирования участника.
* Добавлена кнопка для обмена номером чипа с другим участником в диалоге редактирования участника.
* Добавлена кнопка для поиска участника по имени, фамилии или номеру в диалоге редактирования результата.
* Разрешено изменять время старта в результате, если источник старта — «протокол».

### Исправления

* Исправлен расчет штрафного и бонусного времени для командного результата.
* Исправлено копирование выделенных строк.
* Разделение команд по группам при импорте записей из CSV Orgeo или IOF XML.
* Создание новой команды для каждого участника при импорте из Winorient CSV.

[Все изменения](https://github.com/sembruk/sportorg-plus/compare/v1.6.0...v1.7.0)
