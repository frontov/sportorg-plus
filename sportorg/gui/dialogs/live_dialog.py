...
class LiveDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.item_sending_all_controls = QCheckBox(
            _('Sending the entire contents of the chip')
        )
        self.item_sending_all_controls.setChecked(True)
        self.layout.addRow(self.item_sending_all_controls)

        self.item_result_sending = QCheckBox(_('Online results sending'))
        ...
        self.online_cp_box = QGroupBox(_('Online CP settings'))
        self.online_cp_layout = QFormLayout()

        self.online_cp_from_splits = QCheckBox(_('CP from splits'))
        ...
        self.online_cp_from_finish = QCheckBox(_('Finish as CP'))
